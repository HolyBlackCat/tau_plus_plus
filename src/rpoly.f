...
C THE VALUES BELOW CORRESPOND TO THE BURROUGHS B6700
      BASE = 2.
      ETA = 9.62964972193617926527988971292463659d-35
      INFIN = 1.18973149535723176508575932662800702d+4932
      SMALNO = 6.47517511943802511092443895822764655d-4966
...
C COMPUTE UPPER ESTIMATE OF BOUND
      X = DEXP((DLOG(-PT(NN))-DLOG(PT(1)))/DFLOAT(N))
...
C DECIMAL PLACES
  160 IF (DABS(DX/X).LE..005) GO TO 180
      FF = PT(1)
      DF = FF
      DO 170 I=2,N
        FF = FF*X + PT(I)
